...
const Trips = () => {
  ...
  const fetchServices = async () => {
    try {
      const response = await axios.get('http://localhost:8000/api/services/category/670aaebb9cd7a1208e539231'); // Replace with actual category ID for Cars
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      <h2 className="text-2xl font-bold text-center mb-8 text-pink-500">Honeymoon Trips</h2>
